...
Выполнить установку Docker Engine и docker-compose. Собрать необходимые образы для работы веб-приложения app.war и запустить соответствующие контейнеры.
